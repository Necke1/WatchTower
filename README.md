...
I will be using the Stanza (Stanford NLP) model for this project (specifically CLARIN’s CLASSLA-Stanza model), as it provides pretrained models for many languages, including Serbian. It supports tokenization, POS tagging, lemmatization, dependency parsing, and NER. The Serbian model was trained on Universal Dependencies treebanks, which works well for standard NLP tasks.
